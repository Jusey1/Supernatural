...
public class PossessedModel<T extends Monster> extends HumanoidModel<T> {
	public static final ModelLayerLocation POSSESSED_MODEL = new ModelLayerLocation(new ResourceLocation("supernatural", "possessed"), "main");
