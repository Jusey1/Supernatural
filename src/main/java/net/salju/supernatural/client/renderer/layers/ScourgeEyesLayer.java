...
public class ScourgeEyesLayer<S extends EquineRenderState, M extends ScourgeModel<S>> extends EyesLayer<S, M> {
	public ScourgeEyesLayer(RenderLayerParent<S, M> parent) {
		super(parent);
	}
    ...
    public RenderType renderType() {
        return RenderTypes.eyes(Identifier.fromNamespaceAndPath(Supernatural.MODID, "textures/entity/scourge/scourge_eyes.png"));
    }
}