...
public class ThrallEyesLayer<S extends SupernaturalRenderState, M extends ThrallModel<S>> extends EyesLayer<S, M> {
	public ThrallEyesLayer(RenderLayerParent<S, M> parent) {
		super(parent);
	}
    ...
    public RenderType renderType() {
        return RenderTypes.eyes(Identifier.fromNamespaceAndPath(Supernatural.MODID, "textures/entity/thrall/thrall_eyes.png"));
    }
}