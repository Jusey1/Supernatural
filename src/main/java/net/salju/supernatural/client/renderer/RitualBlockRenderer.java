...
public class RitualBlockRenderer implements BlockEntityRenderer<RitualAltarEntity, SupernaturalBlockState> {
    ...
    @Override
    public void extractRenderState(RitualAltarEntity target, SupernaturalBlockState state, float f1, Vec3 v, ModelFeatureRenderer.CrumblingOverlay progress) {
