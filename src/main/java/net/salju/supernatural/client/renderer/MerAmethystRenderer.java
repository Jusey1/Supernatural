...
public class MerAmethystRenderer extends MobRenderer<MerAmethystEntity, MerModel<MerAmethystEntity>> {
	public MerAmethystRenderer(EntityRendererProvider.Context context) {
		...
		this.addLayer(new EyesLayer<MerAmethystEntity, MerModel<MerAmethystEntity>>(this) {
			@Override
	...
	@Override
	public ResourceLocation getTextureLocation(MerAmethystEntity entity) {
		return new ResourceLocation("supernatural:textures/entities/merfolk_amethyst.png");
	}

	@Override
	public void render(MerAmethystEntity mer, float f1, float f2, PoseStack stack, MultiBufferSource buffer, int inty) {
		stack.pushPose();
