...
public class RitualEvent extends Event {
    ...
    private final RitualBlockEntity target;
    private final int power;
    private final int soulLevel;
    private boolean check = false;

	public RitualEvent(ItemStack stack, ServerLevel lvl, Player player, BlockPos pos, RitualBlockEntity target, int i, int e) {
        this.stack = stack;
        this.lvl = lvl;
        this.player = player;
        this.pos = pos;
    ...
    public RitualBlockEntity getRitualAltar() {
        return this.target;
    }
