...
public class AbstractMerEntity extends Monster implements RangedAttackMob {
	...
	public SoundEvent getAmbientSound() {
		return (this.isInWater() ? SupernaturalModSounds.MERFOLK_WATER_IDLE.get() : SupernaturalModSounds.MERLAND_IDLE.get());
	}

	@Override
	public SoundEvent getHurtSound(DamageSource ds) {
		return (this.isInWater() ? SupernaturalModSounds.MERFOLK_WATER_HURT.get() : SupernaturalModSounds.MERLAND_HURT.get());
	}

	@Override
	public SoundEvent getDeathSound() {
		return (this.isInWater() ? SupernaturalModSounds.MERFOLK_WATER_DEATH.get() : SupernaturalModSounds.MERLAND_DEATH.get());
	}
