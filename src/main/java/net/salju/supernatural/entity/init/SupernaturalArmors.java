...
public class SupernaturalArmors {
    ...
    public static ArmorMaterial EBONSTEEL = new ArmorMaterial(21, getFullArmorMap(3, 8, 6, 3, 15), 21, SoundEvents.ARMOR_EQUIP_IRON, 1.0F, 0.0F, ItemTags.REPAIRS_IRON_ARMOR, createId("ebonsteel"));
