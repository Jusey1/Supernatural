...
public class SupernaturalSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> ARMOR_DEATH = REGISTRY.register("armor_death", () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(Supernatural.MODID, "armor_death")));
	public static final DeferredHolder<SoundEvent, SoundEvent> ARMOR_HURT = REGISTRY.register("armor_hurt", () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(Supernatural.MODID, "armor_hurt")));
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> SPOOK_POOF = REGISTRY.register("spook_poof", () -> SoundEvent.createVariableRangeEvent(Identifier.fromNamespaceAndPath(Supernatural.MODID, "spook_poof")));
