...
public class VampireEntity extends AbstractIllager {
	public VampireEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SupernaturalModEntities.VAMPIRE.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new VampireEntity.VampireBreakDoorGoal(this));
	...
	static class VampireBreakDoorGoal extends BreakDoorGoal {
		public VampireBreakDoorGoal(Mob vampy) {
			super(vampy, 6, VampireEntity.DOOR_BREAKING_PREDICATE);
			this.setFlags(EnumSet.of(Goal.Flag.MOVE));
		}

		public boolean canContinueToUse() {
			VampireEntity vampire = (VampireEntity) this.mob;
