...
public class CoreDarknessItem extends Item {
	public CoreDarknessItem(Item.Properties props) {
		super(props);
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		if (context.getLevel().getBlockState(context.getClickedPos()).is(SupernaturalBlocks.RITUAL_ALTAR) && context.getPlayer() != null && context.getPlayer().isCreative() && context.getItemInHand().is(SupernaturalItems.CORE_DARKNESS)) {
