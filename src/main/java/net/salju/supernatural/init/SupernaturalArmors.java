...
public class SupernaturalArmors {
    public static ArmorMaterial COPPER = new ArmorMaterial(11, Util.make(new EnumMap<>(ArmorType.class), map -> map.put(ArmorType.HELMET, 2)), 13, SoundEvents.ARMOR_EQUIP_COPPER, 0.0F, 0.0F, ItemTags.REPAIRS_COPPER_ARMOR, createId("copper_gothic"));
