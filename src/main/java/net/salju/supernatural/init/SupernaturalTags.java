...
public class SupernaturalTags {
    ...
    public static final TagKey<EntityType<?>> MINION = TagKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Supernatural.MODID, "minion_targets"));
    public static final TagKey<EntityType<?>> IGNORE = TagKey.create(Registries.ENTITY_TYPE, Identifier.fromNamespaceAndPath(Supernatural.MODID, "minion_ignores"));
    ...
    public static final TagKey<Block> CURSED = BlockTags.create(Identifier.fromNamespaceAndPath(Supernatural.MODID, "valid_board_cursed_blocks"));
    public static final TagKey<Block> PROTECTIVE = BlockTags.create(Identifier.fromNamespaceAndPath(Supernatural.MODID, "valid_board_frozen_blocks"));
    public static final TagKey<Block> DESTRUCTIVE = BlockTags.create(Identifier.fromNamespaceAndPath(Supernatural.MODID, "valid_board_magma_blocks"));
    public static final TagKey<Block> TRAP = BlockTags.create(Identifier.fromNamespaceAndPath(Supernatural.MODID, "valid_board_sticky_blocks"));
