...
public class SupernaturalMobs {
	...
	public static final RegistryObject<EntityType<Vampire>> VAMPIRE = register("vampire", EntityType.Builder.<Vampire>of(Vampire::new, MobCategory.MONSTER).setCustomClientFactory(Vampire::new).sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<Necromancer>> NECROMANCER = register("necromancer", EntityType.Builder.<Necromancer>of(Necromancer::new, MobCategory.MONSTER).setCustomClientFactory(Necromancer::new).sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<PossessedArmor>> POSSESSED_ARMOR = register("possessed_armor", EntityType.Builder.<PossessedArmor>of(PossessedArmor::new, MobCategory.MISC).setCustomClientFactory(PossessedArmor::new).sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<Spooky>> SPOOKY = register("spooky", EntityType.Builder.<Spooky>of(Spooky::new, MobCategory.MISC).setCustomClientFactory(Spooky::new).sized(0.4f, 0.6f));
	public static final RegistryObject<EntityType<MerA>> MER_AMETHYST = register("mer_amethyst", EntityType.Builder.<MerA>of(MerA::new, MobCategory.MONSTER).setCustomClientFactory(MerA::new).sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<MerE>> MER_EMERALD = register("mer_emerald", EntityType.Builder.<MerE>of(MerE::new, MobCategory.MONSTER).setCustomClientFactory(MerE::new).sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<MerD>> MER_DIAMOND = register("mer_diamond", EntityType.Builder.<MerD>of(MerD::new, MobCategory.MONSTER).setCustomClientFactory(MerD::new).sized(0.6f, 1.95f));
	public static final RegistryObject<EntityType<Angel>> ANGEL = register("angel", EntityType.Builder.<Angel>of(Angel::new, MobCategory.MISC).setCustomClientFactory(Angel::new).sized(0.6f, 1.95f));
