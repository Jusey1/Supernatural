...
public class SupernaturalMobs {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<Wight>> WIGHT = register("wight", EntityType.Builder.of(Wight::new, MobCategory.MONSTER).sized(0.6F, 1.95F).ridingOffset(-0.6F));
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(POSSESSED_ARMOR.get(), SupernaturalManager.createAttributes(20, 3, 0, 0.25).add(Attributes.KNOCKBACK_RESISTANCE, 0.5).build());
