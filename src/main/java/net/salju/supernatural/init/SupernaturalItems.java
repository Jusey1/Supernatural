...
public class SupernaturalItems {
	...
	public static final RegistryObject<Item> BUNDLE_VANISHING = REGISTRY.register("bundle_of_vanishing", () -> new BundleVanishingItem(new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
