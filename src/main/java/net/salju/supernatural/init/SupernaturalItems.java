...
public class SupernaturalItems {
    ...
    public static final DeferredHolder<Item, Item> CUT_PLASMASTONE_BRICKS = block(SupernaturalBlocks.CUT_PLASMASTONE_BRICKS, "cut_plasmastone_bricks");
    public static final DeferredHolder<Item, Item> CUT_PLASMASTONE_BRICKS_SLAB = block(SupernaturalBlocks.CUT_PLASMASTONE_BRICKS_SLAB, "cut_plasmastone_bricks_slab");
	...
	public static final DeferredHolder<Item, Item> REVENANT_CORE = REGISTRY.register("spectral_core", () -> new Item(createBaseProps("spectral_core").rarity(Rarity.RARE)));
