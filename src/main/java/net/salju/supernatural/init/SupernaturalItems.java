...
public class SupernaturalItems {
	...
	public static final RegistryObject<Item> WEREWOLFISM_CONTRACT = REGISTRY.register("contract_werewolfism", () -> new ContractItem(ContractItem.Types.WEREWOLFISM, Items.BONE, "contract.supernatural.werewolfism", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
