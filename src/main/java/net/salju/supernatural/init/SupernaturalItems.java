...
public class SupernaturalItems {
	...
	public static final RegistryObject<Item> ANIMAL_BLOOD = REGISTRY.register("animal_blood", () -> new DrinkableBloodItem(new Item.Properties().stacksTo(16).food((new FoodProperties.Builder()).nutrition(8).saturationMod(0.0f).build())));
	public static final RegistryObject<Item> VILLAGER_BLOOD = REGISTRY.register("villager_blood", () -> new DrinkableBloodItem(new Item.Properties().stacksTo(16).food((new FoodProperties.Builder()).nutrition(12).saturationMod(0.0f).build())));
	...
	public static final RegistryObject<Item> VAMPIRISM_CONTRACT = REGISTRY.register("contract_vampirism", () -> new ContractItem(ContractItem.Types.VAMPIRISM, Items.GLASS_BOTTLE, "contract.supernatural.vampirism", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> REANIMATE_CONTRACT = REGISTRY.register("contract_reanimate", () -> new ContractItem(ContractItem.Types.REANIMATE, SupernaturalItems.SOULGEM.get(), "contract.supernatural.reanimate", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> VEXATION_CONTRACT = REGISTRY.register("contract_vexation", () -> new ContractItem(ContractItem.Types.VEXATION, Items.CAKE, "contract.supernatural.vexation", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> PUMPKIN_CONTRACT = REGISTRY.register("contract_pumpkin", () -> new ContractItem(ContractItem.Types.PUMPKIN, Items.CARVED_PUMPKIN, "contract.supernatural.pumpkin", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> KNOWLEDGE_CONTRACT = REGISTRY.register("contract_knowledge", () -> new ContractItem(ContractItem.Types.KNOWLEDGE, Items.ENCHANTED_BOOK, "contract.supernatural.knowledge", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
	public static final RegistryObject<Item> FORTUNE_CONTRACT = REGISTRY.register("contract_fortune", () -> new ContractItem(ContractItem.Types.FORTUNE, Items.ENCHANTED_GOLDEN_APPLE, "contract.supernatural.fortune", new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
